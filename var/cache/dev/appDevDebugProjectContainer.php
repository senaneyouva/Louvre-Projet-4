...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'louvre.commandemail' => 'getLouvre_CommandemailService',
            'louvre.commandeserial' => 'getLouvre_CommandeserialService',
            'louvre.commandestripecharge' => 'getLouvre_CommandestripechargeService',
            'louvre.commandetotalprice' => 'getLouvre_CommandetotalpriceService',
            'louvre.daysoff' => 'getLouvre_DaysoffService',
            'louvre.ticketprice' => 'getLouvre_TicketpriceService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('t29g4hdurb', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1liFySa+Nz', 0, 'GR-DyPHBif5fpL9kyGj1W0', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'louvre', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\LouvreBundle\\Entity'))), 'LouvreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LouvreBundle' => 'LouvreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_825a8d3231d28a01d21d0f852a76bd0ea200809fa3ede515124cb53acfd63e1d');
    ...
    /**
     * Gets the public 'louvre.commandemail' shared service.
     *
     * @return \LouvreBundle\InfosCommande\CommandeMail
     */
    protected function getLouvre_CommandemailService()
    {
        return $this->services['louvre.commandemail'] = new \LouvreBundle\InfosCommande\CommandeMail($this->get('swiftmailer.mailer.default'), $this->get('templating'));
    }

    /**
     * Gets the public 'louvre.commandeserial' shared service.
     *
     * @return \LouvreBundle\InfosCommande\CommandeSerial
     */
    protected function getLouvre_CommandeserialService()
    {
        return $this->services['louvre.commandeserial'] = new \LouvreBundle\InfosCommande\CommandeSerial($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'louvre.commandestripecharge' shared service.
     *
     * @return \LouvreBundle\InfosCommande\CommandeStripeCharge
     */
    protected function getLouvre_CommandestripechargeService()
    {
        return $this->services['louvre.commandestripecharge'] = new \LouvreBundle\InfosCommande\CommandeStripeCharge(false);
    }

    /**
     * Gets the public 'louvre.commandetotalprice' shared service.
     *
     * @return \LouvreBundle\InfosCommande\CommandeTotalPrice
     */
    protected function getLouvre_CommandetotalpriceService()
    {
        return $this->services['louvre.commandetotalprice'] = new \LouvreBundle\InfosCommande\CommandeTotalPrice($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'louvre.daysoff' shared service.
     *
     * @return \LouvreBundle\InfosCommande\DaysOff
     */
    protected function getLouvre_DaysoffService()
    {
        return $this->services['louvre.daysoff'] = new \LouvreBundle\InfosCommande\DaysOff($this->get('doctrine.orm.default_entity_manager'), array(0 => 1000));
    }

    /**
     * Gets the public 'louvre.ticketprice' shared service.
     *
     * @return \LouvreBundle\InfosCommande\TicketPrice
     */
    protected function getLouvre_TicketpriceService()
    {
        return $this->services['louvre.ticketprice'] = new \LouvreBundle\InfosCommande\TicketPrice($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_horizontal_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\LouvreBundle/Resources/views'), 'Louvre');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oKygc7O70W', 0, 'GR-DyPHBif5fpL9kyGj1W0', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59afee22cb9834.98986491')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'LouvreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LouvreBundle'),
                    'namespace' => 'LouvreBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LouvreBundle' => 'LouvreBundle\\LouvreBundle',
            ...
            'mailer_host' => false,
            'mailer_username' => false,
            'mailer_password' => false,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'stripekey' => false,
            'limit_billets_days' => 1000,
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => false,
            'swiftmailer.mailer.default.transport.smtp.username' => false,
            'swiftmailer.mailer.default.transport.smtp.password' => false,
